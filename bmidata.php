...
<div class="container">
    <div class="row justify-content-center">
    <div class="col-sm-2"> <a style="border:2px solid red;width:100%;color:red;background-color:white;border-radius:25px;padding:10px;" href="data2.php"><b>GYM DATA</b></a></div>
        <div class="col-sm-2"><a style="color:white;background-color:red;width:100%;border-radius:25px;padding:10px;" href="bmidata.php"><b>BMI DATA</b></a></div>
    </div>
</div>
<br><br>
<div class="container"  >
    <div class="row justify-content-center"  style="color:white;font-weight:bolder; border:1px solid white">
                ...
                <div class="col-sm-2" style="background-color:red;border:2px solid white;padding:10px">DATE</div>             
                <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">WEIGHT</div>             
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">HEIGHT</div>
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">GENDER</div>
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">BMI</div>
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">REMARK</div>
            </div>
</div>
...
<script>
    ...
    <?php
    $sqlget = "SELECT name,id,age,gender,height,weight,bmi,remark,times,year(times) as yr,month(times) as mn,day(times) as dt FROM userdataprog where id = '$id'";
            ...
            z.addEventListener("click",()=>
        {
            ...
            function display(){
                ...
                <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">${z.ag}</div>             
                 <div class="col-sm-2" style="border:2px solid white;background-color:red;padding:10px">${z.tp}</div>
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">${z.wt}</div>             
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">${z.ht}</div>
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">${z.gn}</div>
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">${z.bmi}</div>
                 <div class="col-sm-1" style="border:2px solid white;background-color:red;padding:10px">${z.rm}</div>
                </div>`;
                console.log(z);
            })
