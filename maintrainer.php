...
<div class="row justify-content-center">
    <div class="col-sm-1">
        <button style="border-radius:25px;color:white;background-color:red;border:4px solid red;PADDING:5PX; " id="in" onclick="data()"><b>IN-DATA</b></button>
    </div>
    <div class="col-sm-1">
        <button style="border-radius:25px;color:red;background-color:white;border:4px solid red;PADDING:5PX;" id="out" onclick="data2()"><b>OUT-DATA</b></button>
    </div>
</div>
<br><br>
...
<script>
    ...
    <?php
    $sqlget = "SELECT * FROM INDATA where type='MEMBER'";
   ...
   b.forEach(z => {
            z.addEventListener("click",()=>
        {
            ...
            function display(){
                ...
                <div class="col-sm-2"style="border:2px solid white;padding:10px"><a href="insertdata.php?id=${z.us}" style="border-radius:25px;border:4px solid white;padding-left:15px;padding-right:15px">IN</a></div>
                </div>`;
                console.log(z);
            })
...
function data(){
   ...
   window.location.href = "maintrainer.php";
}
function data2(){
   ...
   window.location.href = "outdata.php";
}
function ts(){
