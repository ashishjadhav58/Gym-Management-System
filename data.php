...
<div class="row justify-content-center">
    <DIV class="col-sm-2">
   <b style="color:red">BY NAME </b><input type="radio" name="as" id="as1" value="1">
   <b style="color:red">BY DATE </b><input type="radio" name="as" id="as2" value="2"></DIV>
</div>
<br><br>
<div class="container"  >
...
<script>
    ...
    <?php
    $sqlget = "SELECT name,username,age,reg_date,year(reg_date) as yr,month(reg_date) as mn,day(reg_date) as dt FROM entrydaily ";
...
function search(){
    ...
    let tpp=document.getElementById("as1").checked;
    let tpp1=document.getElementById("as2").checked;
    if(tpp == true){
